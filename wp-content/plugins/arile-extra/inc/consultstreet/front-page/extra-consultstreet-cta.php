<?php 
if('ConsultStreet' == $activate_theme || 'BrightPress' == $activate_theme || 'AssentPress' == $activate_theme || 'EnvoPress' == $activate_theme){	   $title = 'Do you have any questions?';
...
if($consultstreet_cta_disabled == true): ?>
	...
	<section class="theme-cta <?php if('EnvoPress' == $activate_theme){echo 'vrsn-two';}?>" id="theme-cta" style="background-image:url('<?php echo esc_url($consultstreet_cta_background_image);?>'"); >
		<div class="theme-cta-overlay"></div>
		<div class="container">			
			<div class="row">
			<?php if('EnvoPress' == $activate_theme){ ?>
