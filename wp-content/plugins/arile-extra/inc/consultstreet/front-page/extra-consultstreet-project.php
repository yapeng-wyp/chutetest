<?php
if('ConsultStreet' == $activate_theme || 'BrightPress' == $activate_theme || 'AssentPress' == $activate_theme || 'EnvoPress' == $activate_theme){	   $title = 'Our Latest Projects';
...
if($consultstreet_project_disabled == true): ?>
	<section class="theme-block theme-project theme-bg-grey <?php if('EnvoPress' == $activate_theme){echo 'vrsn-three';}?>" id="theme-project">
