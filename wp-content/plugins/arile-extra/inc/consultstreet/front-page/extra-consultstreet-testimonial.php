...
?>
<section class="theme-block theme-testimonial <?php if('EnvoPress' == $activate_theme){echo 'vrsn-three';}?>" id="theme-testimonial">	
	<div class="container">	
	    ...
	    <?php endif; ?>
			...
			$allowed_html = array('br' => array(), 'em' => array(), 'strong' => array(), 'b' => array(),'i' => array());
					...
					?>
					    <?php if('EnvoPress' == $activate_theme){echo '<div class="col-lg-4 col-md-6 col-sm-12">';}else{echo'<div class="col-lg-12 col-md-12 col-sm-12">';}?>
