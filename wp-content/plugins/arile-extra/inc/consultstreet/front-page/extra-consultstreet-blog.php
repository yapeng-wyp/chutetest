...
if($consultstreet_blog_disabled == true): ?>
	<section class="theme-block theme-blog <?php if($activate_theme == 'BrightPress' || $activate_theme == 'FitnessBase' || $activate_theme == 'Beauty Spa Salon') { echo 'list-view-news'; } ?><?php if('EnvoPress' == $activate_theme){echo 'vrsn-three';}?>" id="theme-blog">
	 <?php if($consultstreet_blog_area_title != null || $consultstreet_blog_area_des != null): ?>
        ...
        $post_args = array( 'post_type' => 'post', 'category__in' => $consultstreet_theme_blog_category, 'post__not_in'=>get_option("sticky_posts")) ;
			...
			{	
				...
				{ ?>
				<?php if($activate_theme == 'ConsultStreet' || 'AssentPress' == $activate_theme || $activate_theme == 'Decorexo'): ?>
				...
				<?php if($activate_theme == 'BrightPress' || $activate_theme == 'FitnessBase' || $activate_theme == 'Beauty Spa Salon'): ?>
				...
				<?php if($activate_theme == 'EnvoPress'): ?>
