...
if('ConsultStreet' == $activate_theme || 'FitnessBase' == $activate_theme || 'AssentPress' == $activate_theme || 'Beauty Spa Salon' == $activate_theme || 'Decorexo' == $activate_theme || 'EnvoPress' == $activate_theme){		$text_align = 'center';	
}
if('BrightPress' == $activate_theme){
    $text_align = 'left';				
}
if($consultstreet_service_area_disabled == true): ?>
<section class="theme-block theme-services <?php if('FitnessBase' == $activate_theme){ echo 'theme-bg-gradient-bg'; }?><?php if('EnvoPress' == $activate_theme){echo 'vrsn-three';}?>" id="theme-services">
	<div class="container">
	<?php  
