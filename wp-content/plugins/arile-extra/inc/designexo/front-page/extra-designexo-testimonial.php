...
if('Designexo' == $activate_theme || 'InteriorWP' == $activate_theme || 'Designexo Child Theme' == $activate_theme || 'Architect Decor' == $activate_theme || 'Architects' == $activate_theme || 'Interior Dark' == $activate_theme){
$designexo_testimonial_area_des = get_theme_mod('designexo_testimonial_area_des', __('WHAT OUR CLIENTS SAY ABOUT US','arile-extra'));
}
if('IntecoPress' == $activate_theme){ $designexo_testimonial_area_des = 'WHAT OUR CLIENTS SAY'; }
...
?>
<section class="theme-block theme-testimonial vrsn-two <?php if('Interior Dark' == $activate_theme){ echo 'vrsn-three'; } ?>" id="theme-testimonial">	
