...
<section class="theme-main-slider <?php if('Interior Dark' == $activate_theme){ echo 'vrsn-three'; } ?>" id="theme-slider">
		...
		<?php 
			...
			<?php if($title != '' || $img_description!= '' || $readmore_button!=''){ ?>
				<div class="container theme-slider-content">
					<div class="theme-text-<?php if('Designexo' == $activate_theme || 'Designexo Child Theme' == $activate_theme || 'Architect Decor' == $activate_theme || 'Interior Dark' == $activate_theme){ echo 'left'; } ?><?php if('Empresa' == $activate_theme || 'InteriorWP' == $activate_theme || 'Architects' == $activate_theme || 'Monster Dark' == $activate_theme || 'NewsMedia' == $activate_theme){ echo 'center'; } ?> theme-caption-bg<?php if('Empresa' == $activate_theme || 'Architects' == $activate_theme){ echo '2'; } ?> <?php if('InteriorWP' == $activate_theme || 'Monster Dark' == $activate_theme || 'NewsMedia' == $activate_theme){ echo 'align-center';} ?>">
					<?php if($subtitle != ''){ ?>
			...
			<?php if('NewsMedia' == $activate_theme){ ?>
