...
class QUBELY_MAIN {
	...
	public function qubely_enqueue_scripts() {
		 ...
		 * register scripts
		 */
		wp_register_script( 'qubley-animated-headline-script', QUBELY_DIR_URL . 'assets/js/jquery.animatedheadline.min.js', array( 'jquery' ), QUBELY_VERSION, true );
		wp_register_script( 'qubely-block-map', QUBELY_DIR_URL . 'assets/js/blocks/map.min.js', array( 'jquery' ), QUBELY_VERSION, true );
		wp_register_script( 'qubely-magnific-popup-script', QUBELY_DIR_URL . 'assets/js/qubely.magnific-popup.min.js', array( 'jquery' ), QUBELY_VERSION, true );
		wp_register_script( 'qubely-block-contactform', QUBELY_DIR_URL . 'assets/js/blocks/contactform.min.js', array( 'jquery' ), QUBELY_VERSION, true );
		wp_register_script( 'qubely-block-image-comparison', QUBELY_DIR_URL . 'assets/js/blocks/image-comparison.min.js', array(), QUBELY_VERSION, true );
		wp_register_script( 'qubely-block-common', QUBELY_DIR_URL . 'assets/js/common-script.min.js', array( 'jquery' ), QUBELY_VERSION, true );
		wp_register_script( 'qubely-interaction', QUBELY_DIR_URL . 'assets/js/interaction.min.js', array( 'jquery' ), QUBELY_VERSION, true );
	...
	public function add_static_css(){
		...
		//Scripts
		wp_enqueue_script( 'qubely-magnific-popup-script', QUBELY_DIR_URL . 'assets/js/qubely.magnific-popup.min.js', array( 'jquery' ), QUBELY_VERSION, true );
		...
		wp_enqueue_script( 'qubely-block-map', QUBELY_DIR_URL . 'assets/js/blocks/map.min.js', array( 'jquery' ), QUBELY_VERSION, true );
		wp_enqueue_script( 'qubely-block-image-comparison', QUBELY_DIR_URL . 'assets/js/blocks/image-comparison.min.js', array( 'jquery' ), QUBELY_VERSION, true );
		wp_enqueue_script( 'qubely-block-contactform', QUBELY_DIR_URL . 'assets/js/blocks/contactform.min.js', array( 'jquery' ), QUBELY_VERSION, true );
		wp_enqueue_script( 'qubely-block-common', QUBELY_DIR_URL . 'assets/js/common-script.min.js', array( 'jquery' ), QUBELY_VERSION, true );
	}
