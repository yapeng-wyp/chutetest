	...
	<?php if( $display_type == 'dropdown' ){
		...
		if( 
			...
			if( 
				...
				?>
				<div 
					class="wcpt-dropdown-option wcpt-term-ancestor wcpt-term-ancestor-all "
					data-wcpt-value=""
				>
					<label 
						class="" 
			...
			if( $term = get_term_by( 'slug', $sc_attrs['_term'], 'product_cat' ) ){
				...
				if( $ancestors = get_ancestors( $term->term_taxonomy_id, 'product_cat', 'taxonomy' ) ){
					...
					foreach( $ancestors as $ancestor_id ){
						...
						<div 
							...
							data-wcpt-value="<?php echo $ancestor->term_taxonomy_id ?>"
						>
							<label 
								class="" 
								data-wcpt-value="<?php echo $ancestor->term_taxonomy_id ?>"
				...
				<div 
					...
					data-wcpt-value="<?php echo $term->term_taxonomy_id ?>"
				>
					<label 
						class="" 
						data-wcpt-value="<?php echo $term->term_taxonomy_id ?>"
