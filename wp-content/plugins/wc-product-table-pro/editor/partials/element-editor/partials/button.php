...
>
  ...
  <div class="wcpt-editor-row-option">
    ...
    <div
      ...
      wcpt-be-add-row="0"
      wcpt-be-add-element-partial="add-button-element"      
    ></div>
  </div>
  ...
  <div 
    ...
    wcpt-condition-val="custom||cart_custom"
  ...
  <!-- custom field -->
  <div class="wcpt-editor-row-option" wcpt-panel-condition="prop" wcpt-condition-prop="link" wcpt-condition-val="custom_field||custom_field_media_id||custom_field_acf">
  ...
  <div class="wcpt-editor-row-option" wcpt-model-key="style">
    ...
    <div class="wcpt-editor-row-option wcpt-toggle-options wcpt-row-accordion" wcpt-model-key="[id] .wcpt-cart-badge-number">
