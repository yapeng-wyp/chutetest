...
<div class="wcpt-option-row">
  ...
  <div class="wcpt-input">
    <textarea wcpt-model-key="ids" placeholder="<?php _e( "Enter comma separated product IDs", 'wc-product-table' ); ?>"></textarea>
    </select>
  </div>
</div>
...
<div class="wcpt-option-row">
  ...
  <div class="wcpt-input">
    <textarea wcpt-model-key="skus" placeholder="<?php _e( "Enter comma separated product SKUs", 'wc-product-table' ); ?>"></textarea>
    </select>
  </div>
</div>
  ...
  <div class="wcpt-input" style="position: relative;">
    ...
    <span class="wcpt-additional-query-args-info wcpt-toggle wcpt-toggle-off" style="z-index: 1;">
      ...
      <span class="wcpt-toggle-tray">
        <p>
        This feature is for wordpress developers only. It accepts <a href="https://developer.wordpress.org/reference/classes/wp_query/" target="_blank">WP Query</a> args in parameterized form. For example: posts_per_page=10&orderby=title
        </p>
        <p>
        If you need to filter by category, taxonomy, tags, attributes or custom fields, you can use <a href="https://wcproducttable.com/documentation/shortcode-attribute" target="_blank">shortcode attributes</a> included in WCPT like [product_table id="123" category="cat 1, cat 2"]. Some of the shortcode attributes are <a href="https://pro.wcproducttable.com/" target="_blank">WCPT PRO</a> exclusive.
        </p>
      </span>
